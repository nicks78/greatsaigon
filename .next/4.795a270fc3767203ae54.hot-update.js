...
var SearchPage = function (_React$Component) {
  ...
  function SearchPage() {
    ...
    _this.updateResult = function () {
      _this.setState({
        where: _this.props.url.query.where,
        what: _this.props.url.query.what,
        directory: _this.props.url.query.directory
      }, function () {
        console.log('WHERE-2', _this.state.where);
...
//# sourceMappingURL=4.795a270fc3767203ae54.hot-update.js.map